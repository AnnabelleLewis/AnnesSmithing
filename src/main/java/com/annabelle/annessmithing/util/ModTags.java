...
public class ModTags {
    public static class Items {
        ...
        public static final TagKey<Item> SWORD_HEADS = tag("tool_components/sword_head");
        public static final TagKey<Item> AXE_HEADS = tag("tool_components/axe_head");
        public static final TagKey<Item> SHOVEL_HEADS = tag("tool_components/shovel_head");
